...
class ReplyTopicTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.topic = Topic.objects.create(subject='Hello, world', exchange=self.exchange, starter=user)
        Post.objects.create(message='Lorem ipsum dolor sit amet', topic=self.topic, created_by=user)
        self.url = reverse('reply_topic', kwargs={'pk': self.exchange.pk, 'topic_pk': self.topic.pk})
...
class ReplyTopicTests(ReplyTopicTestCase):
    ...
    def test_view_function(self):
        view = resolve('/exchanges/1/topics/1/reply/')
...
class SuccessfulReplyTopicTests(ReplyTopicTestCase):
    ...
    def test_redirection(self):
        ...
        '''
        url = reverse('topic_posts', kwargs={'pk': self.exchange.pk, 'topic_pk': self.topic.pk})
